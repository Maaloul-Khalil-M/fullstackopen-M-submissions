...
` +
    ...
    var Gn = Dn(
      ...
      Jn = Dn(m({}, On, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Yn = Dn(
        m({}, Fn, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      Xn = Dn(m({}, On, { newState: 0, oldState: 0 })),
      Zn = [9, 13, 27, 32],
        ...
        if (a === 0) {
          ...
          a: {
            ...
            if ((t & 62914560) === t && ((a = $l + 300 - Fe()), 10 < a)) {
              if ((yu(r, t, Jl, !Vl), A(r, 0, !0) !== 0)) break a;
              ((su = t),
                (r.timeoutHandle = Kd(
                  _u.bind(
                    null,
...
var { toString: y } = Object.prototype,
  ...
  { iterator: x, toStringTag: ee } = Symbol,
  S = ((e) => (t) => {
    let n = y.call(t);
...
var Oe =
  ...
  ke = (e) => !re(e) && e !== Oe;
function Ae() {
  let { caseless: e, skipUndefined: t } = (ke(this) && this) || {},
    n = {},
    r = (r, i) => {
...
var je = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Le = (
    (e) => (t) =>
      e && t instanceof e
  )(typeof Uint8Array < `u` && b(Uint8Array)),
  Re = (e, t) => {
    let n = (e && e[x]).call(e),
      r;
    for (; (r = n.next()) && !r.done; ) {
...
function Ye(e) {
  return !!(e && T(e.append) && e[ee] === `FormData` && e[x]);
}
var Xe = (e) => {
    let t = Array(10),
      n = (e, r) => {
  ...
  Ze = C(`AsyncFunction`),
  Qe = (e) => e && (ce(e) || T(e)) && T(e.then) && T(e.catch),
  $e = ((e, t) =>
    e
      ? setImmediate
      : t
...
function rt(e) {
  return k.isArray(e) && !e.some(et);
}
var it = k.toFlatObject(k, {}, null, function (e) {
...
function at(e, t, n) {
  ...
  function l(e, n, i) {
    ...
    if (k.isReactNative(t) && k.isReactNativeBlob(e))
      return (t.append(nt(i, n, a), c(e)), !1);
...
var dt = class {
  ...
  yt = (ht && window.location.href) || `http://localhost`,
  bt = { ...mt, ...pt };
function xt(e, t) {
  return at(e, new bt.classes.URLSearchParams(), {
    visitor: function (e, t, n, r) {
      return bt.isNode && k.isBuffer(e)
...
function Pt(e) {
  return e === !1 || e == null ? e : k.isArray(e) ? e.map(Pt) : Nt(String(e));
}
function Ft(e) {
...
var Bt = class {
  ...
  set(e, t, n) {
    ...
    else if (k.isString(e) && (e = e.trim()) && !It(e)) a(Ot(e), t);
  ...
  has(e, t) {
    if (((e = Mt(e)), e)) {
      let n = k.findKey(this, e);
      return !!(n && this[n] !== void 0 && (!t || Lt(this, this[n], n, t)));
    }
    return !1;
  }
  delete(e, t) {
    ...
    function i(e) {
      if (((e = Mt(e)), e)) {
        let i = k.findKey(n, e);
        i && (!t || Lt(n, n[i], i, t)) && (delete n[i], (r = !0));
      }
    }
  ...
  clear(e) {
    ...
    for (; n--; ) {
      let i = t[n];
      (!e || Lt(this, this[i], i, e, !0)) && (delete this[i], (r = !0));
    }
    return r;
  }
  normalize(e) {
...
`);
  ...
  static accessor(e) {
    let t = (this[kt] = this[kt] = { accessors: {} }).accessors,
      n = this.prototype;
    function r(e) {
      let r = Mt(e);
      t[r] || (zt(n, e), (t[r] = !0));
...
(Bt.accessor([
  ...
  k.reduceDescriptors(Bt.prototype, ({ value: e }, t) => {
...
var Jt = (e, t, n = 3) => {
  ...
  Xt =
    ...
    (...t) =>
      k.asap(() => e(...t)),
  Zt = bt.hasStandardBrowserEnv
    ? ((e, t) => (n) => (
        (n = new URL(n, bt.origin)),
...
function tn(e, t, n) {
  let r = !$t(t);
  return e && (r || n == 0) ? en(e, t) : t;
}
var nn = (e) => (e instanceof Bt ? { ...e } : e);
function rn(e, t) {
  t ||= {};
  let n = {};
  function r(e, t, n, r) {
...
var an = (e) => {
    ...
    if (
      ...
      (t.url = ut(
        tn(t.baseURL, t.url, t.allowAbsoluteUrls),
        e.params,
        e.paramsSerializer,
      )),
      s &&
    ...
    if (
      ...
      (r && k.isFunction(r) && (r = r(t)), r || (r !== !1 && Zt(t.url)))
    ) {
      let e = i && a && Qt.read(a);
      e && o.set(i, e);
    }
    ...
    function (e) {
      return new Promise(function (t, n) {
        ...
        (`onloadend` in h
          ...
          c && (([d, p] = Jt(c, !0)), h.addEventListener(`progress`, d)),
          s &&
            h.upload &&
            (([u, f] = Jt(s)),
          ...
          (r.cancelToken || r.signal) &&
            ((l = (t) => {
              h &&= (n(!t || t.type ? new Ut(null, e, h) : t), h.abort(), null);
            }),
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof A ? t : new Ut(t instanceof Error ? t.message : t),
            );
          }
        },
        a =
  ...
  ln = async function* (e, t) {
    for await (let n of un(e)) yield* cn(n, t);
  },
  un = async function* (e) {
  ...
  fn = 64 * 1024,
  { isFunction: pn } = k,
  mn = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
    k.global,
  ),
  { ReadableStream: hn, TextEncoder: gn } = k.global,
  _n = (e, ...t) => {
    try {
      return !!e(...t);
    } catch {
  ...
  vn = (e) => {
    e = k.merge.call({ skipUndefined: !0 }, mn, e);
    let { fetch: t, Request: n, Response: r } = e,
      i = t ? pn(t) : typeof fetch == `function`,
      a = pn(n),
      o = pn(r);
    if (!i) return !1;
    let s = i && pn(hn),
      ...
      u = o && s && _n(() => k.isReadableStream(new r(``).body)),
      d = { stream: u && ((e) => e.body) };
    i &&
    ...
    let f = async (e) => {
        ...
        if (k.isSpecCompliantForm(e))
          return (
            await new n(bt.origin, { method: `POST`, body: e }).arrayBuffer()
          ).byteLength;
    ...
    return async (e) => {
      ...
      let ee = sn([c, f && f.toAbortSignal()], m),
        S = null,
        C =
          ee &&
          ee.unsubscribe &&
  ...
  bn = (e) => {
    ...
    for (; o--; )
      ((s = a[o]),
        (c = l.get(s)),
        c === void 0 && l.set(s, (c = o ? new Map() : vn(t))),
        (l = c));
    return c;
  };
bn();
var xn = { http: null, xhr: on, fetch: { get: bn } };
k.forEach(xn, (e, t) => {
  if (e) {
    try {
...
var Sn = (e) => `- ${e}`,
  Cn = (e) => k.isFunction(e) || e === null || e === !1;
function wn(e, t) {
  e = k.isArray(e) ? e : [e];
  let { length: n } = e,
    r,
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((i = r),
      !Cn(r) && ((i = xn[(n = String(r)).toLowerCase()]), i === void 0))
    )
...
var Tn = { getAdapter: wn, adapters: xn };
function En(e) {
  if (
...
function Dn(e) {
  return (
    ...
    (e.data = Vt.call(e, e.transformRequest)),
    [`post`, `put`, `patch`].indexOf(e.method) !== -1 &&
      e.headers.setContentType(`application/x-www-form-urlencoded`, !1),
    Tn.getAdapter(
      e.adapter || Et.adapter,
      e,
    )(e).then(
      function (t) {
        return (
          En(e),
          (t.data = Vt.call(e, e.transformResponse, t)),
      ...
      function (t) {
        return (
          Ht(t) ||
            ...
            t &&
              t.response &&
              ((t.response.data = Vt.call(e, e.transformResponse, t.response)),
              (t.response.headers = Bt.from(t.response.headers)))),
          Promise.reject(t)
        );
      },
    )
...
` + n);
    ...
    _request(e, t) {
      ...
      (i &&
        ...
        (t.headers = Bt.concat(a, i)));
      let o = [],
        s = !0;
      this.interceptors.request.forEach(function (e) {
        if (typeof e.runWhen == `function` && e.runWhen(t) === !1) return;
        s &&= e.synchronous;
        let n = t.transitional || ft;
    ...
    getUri(e) {
      return (
        ...
        ut(
          tn(e.baseURL, e.url, e.allowAbsoluteUrls),
          e.params,
          e.paramsSerializer,
        )
      );
...
(k.forEach([`delete`, `get`, `head`, `options`], function (e) {
  Pn.prototype[e] = function (t, n) {
    return this.request(
      rn(n || {}, { method: e, url: t, data: (n || {}).data }),
    );
  };
}),
...
var Fn = class e {
  constructor(e) {
    ...
    (this.promise.then((e) => {
      ...
      e(function (e, r, i) {
        n.reason || ((n.reason = new Ut(e, r, i)), t(n.reason));
      }));
  }
  throwIfRequested() {
...
function zn(e) {
  let t = new Pn(e),
    n = v(Pn.prototype.request, t);
  return (
    k.extend(n, Pn.prototype, t, { allOwnKeys: !0 }),
...
((j.Axios = Pn),
  ...
  (j.mergeConfig = rn),
  (j.AxiosHeaders = Bt),
  (j.formToJSON = (e) => wt(k.isHTMLForm(e) ? new FormData(e) : e)),
  (j.getAdapter = Tn.getAdapter),
  (j.HttpStatusCode = Rn),
  (j.default = j));
var Bn = l(_(), 1),
  Vn = `/api/persons`,
  Hn = {
    getAll: () => j.get(Vn).then((e) => e.data),
    create: (e) => j.post(Vn, e).then((e) => e.data),
    delete: (e) => j.delete(`${Vn}/${e}`).then((e) => e.data),
    modify: (e, t) => j.put(`${Vn}/${e}`, t).then((e) => e.data),
  },
  Un = o((e) => {
    var t = Symbol.for(`react.transitional.element`);
    function n(e, n, r) {
    ...
    (0, M.jsx)(`div`, {
      children:
        e.length > 0
          ...
          : (0, M.jsx)(`p`, { children: `No contacts found` }),
    }),
  Gn = ({
    addPerson: e,
    newName: t,
    ...
    (0, M.jsxs)(`form`, {
      ...
      children: [
        (0, M.jsxs)(`div`, {
          className: `form-row`,
          children: [
            (0, M.jsx)(`p`, { children: `name` }),
            ` `,
            (0, M.jsx)(`input`, { value: t, onChange: n }),
          ],
        }),
        (0, M.jsxs)(`div`, {
          className: `form-row`,
          children: [
            (0, M.jsx)(`p`, { children: `number` }),
            (0, M.jsx)(`input`, { type: `tel`, value: r, onChange: i }),
          ],
        }),
        (0, M.jsx)(`div`, {
  ...
  Kn = ({ value: e, onChange: t }) =>
    (0, M.jsxs)(`div`, {
      ...
      children: [
        ...
        ` `,
        (0, M.jsx)(`input`, { value: e, onChange: t }),
      ],
    }),
  qn = p(),
  Jn = ({ feedback: e }) => {
    let [t, n] = (0, qn.useState)(!1);
    return (
      (0, qn.useEffect)(() => {
        if (e.msg === null) {
          n(!1);
        ...
        n(!0);
        let t = setTimeout(() => n(!1), 3e3);
        return () => clearTimeout(t);
      }, [e]),
      (0, M.jsx)(`div`, {
        className: `notification ${e.isError ? `error` : ``} ${t ? `visible` : ``}`,
        children: e.msg,
      })
    );
  };
Bn.createRoot(document.getElementById(`root`)).render(
  (0, M.jsx)(() => {
    let [e, t] = (0, qn.useState)([]),
      [n, r] = (0, qn.useState)(``),
      [i, a] = (0, qn.useState)(``),
      [o, s] = (0, qn.useState)(``),
      [c, l] = (0, qn.useState)({ msg: null, isError: !1 });
    (0, qn.useEffect)(() => {
      Hn.getAll().then((e) => {
        t(e);
      });
    ...
    let u = (e, t) =>
        e.find((e) => e.name.toUpperCase() === t.name.toUpperCase()),
      d = (e, i) => {
        confirm(
          `${e.name} is already added to phonebook\nReplace the old number with the new one?`,
        ) &&
          (Hn.modify(e.id, i)
            .then((n) => {
              (t((t) => t.map((t) => (t.id === e.id ? n : t))),
                l((t) => ({
                  msg: `${e.name} was successfully modified`,
                  isError: !1,
                })));
            })
            .catch((e) => {
              l((e) => ({
                msg: `Information of ${n} has already been removed from server`,
                isError: !0,
              }));
            }),
          r(``),
        ...
        Hn.create(s)
          ...
          .catch((e) => {
            (console.log(e.response.data.error),
              l((t) => ({
                msg: `mongoose: ${e.response.data.error}`,
                isError: !0,
              })));
          });
      },
        ...
        confirm(`Delete ${e.name} ?`) &&
          Hn.delete(e.id).then(() => {
            (t((t) => t.filter((t) => t.id !== e.id)),
              l((t) => ({
                msg: `${e.name} was successfully deleted`,
                isError: !1,
              })),
              s(``));
          });
      ...
      _ = e.filter((e) => e.name.toLowerCase().includes(o.toLowerCase()));
    return (0, M.jsxs)(`div`, {
      className: `page-wrapper grid-animated-container`,
      children: [
        (0, M.jsx)(`div`, {
            ...
            children: [
              (0, M.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, M.jsx)(Jn, { feedback: c }),
                  (0, M.jsx)(Kn, { value: o, onChange: g }),
                  (0, M.jsx)(`h2`, { children: `add a new` }),
                  (0, M.jsx)(Gn, {
                    addPerson: f,
                    newName: n,
                    nameHandler: m,
              ...
              (0, M.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, M.jsx)(Wn, { persons: _, deletePerson: p }),
                ],
              }),
            ],
          }),
